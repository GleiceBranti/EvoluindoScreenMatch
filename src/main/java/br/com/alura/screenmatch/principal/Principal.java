...
public class Principal {
    ...
    private void buscarSereiesPorCategoria() {
    ...
    private void buscarEpisodioPorTrecho() {
        ...
        List<Episodio> epsiosidosEncontrados = repositorio.episodiosPorTrecho(trechoEpisodio);
        epsiosidosEncontrados.forEach(e ->
